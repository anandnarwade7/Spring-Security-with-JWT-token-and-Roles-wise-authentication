...
public class FileOperationService {
	...
	private static final List<String> headersToCheck = Arrays.asList("Availability", "Product Name", "Item Name",
			...
			"Selling Price", "Cost", "Price", "Usd price", "Avail", "Availability", "Accessibility", "Brand",
			"Quantity", "Avail qty", "Qty", "Total qty", "Total quantity", "Type", "Kind", "Variety", "Design",
			"Designer", "Hyperlink", "Link", "Order", "Order qty", "Qty order", "Barcode");
